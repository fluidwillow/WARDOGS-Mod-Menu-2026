# 🟢 WARDOGS External Menu — Vehicle, Objective & Map Toolkit

**WARDOGS External Menu** is a desktop-style overlay concept tailored to WARDOGS' large-scale combined-arms battlefield.

This variant emphasizes vehicles, logistics, objective information, map panels, squad-oriented layouts, and profile presets for different battlefield roles.
...
Focus: Vehicles / objectives / map tools
```
